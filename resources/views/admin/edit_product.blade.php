                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ route('update_product') }}" method="POST"
                                    ...
                                    <div class="form-group color">
                                        ...
                                        <input value="{{ $product->title }}" type="text" name="title"
                                            style="color: white !important" class="form-control" id="exampleInputName1"
                                    ...
                                    <div class="form-group color">
                                        ...
                                        <textarea style="color: white !important" value="{{ old('description') }}" class="form-control" name="description"
                                            placeholder="Product description" id="exampleTextarea1" rows="4"></textarea>
                                    </div>
                                    @error('price')
                                        <label style="color: red">{{ $message }}</label>
                                    @enderror
                                    <div class="form-group color">
                                        ...
                                        <input style="color: white !important" value="{{ $product->price }}"
                                    ...
                                    <div class="form-group color">
                                        ...
                                        <input style="color: white !important" value="{{ $product->percent }}"
                                            type="number" class="form-control" id="exampleInputName1"
                                    ...
                                    <div class="form-group color">
                                        ...
                                        <input style="color: white !important" value="{{ $product->quantity }}"
                                            type="number" class="form-control" id="exampleInputName1"
                                    ...
                                    <div class="form-group color">
                                        ...
                                        <select style="color: white !important" name="catagory"
