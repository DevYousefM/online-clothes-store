...
<body>
    ...
    @if (count($women) > 0)
        ...
        <section class="section" id="women">
            <div class="container" id="accessori">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section-heading">
                            <h2>Women's Latest
    ...
    @if (count($kids) > 0)
        ...
        <section class="section" id="kids">
            <div class="container" id="carbone">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section-heading">
                            <h2>Kids's Latest
                                    ...
                                    @if ($item->percent > 0)
                                        <div class="item">
                                            ...
                                            <div class="down-content p-1">
                                                ...
                                                <span
                                                    style="color: white;background:red;width: fit-content;padding:3px 7px;border-radius:5px">%{{ $item->percent }}</span>
                                                <div class="d-flex mt-2 align-items-center">
                                                    <span style="text-decoration:line-through;">
                                                        ${{ $item->price }}
                                                    </span>
                                                    <span
                                                        style="margin-left: 5px;text-decoration:none !important;font-size:30px;color:black">
