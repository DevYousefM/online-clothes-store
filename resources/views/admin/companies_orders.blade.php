                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item bg-dark">
                                        <h2 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button collapsed bg-secondary text-dark"
                                                ...
                                                <form class="col-md-12 text-center mt-2" action="update_order"
                                                    ...
                                                    <div class="form-group color">
                                                        <select style="color: white !important" name="order_status"
                                                            style="color: rgba(255, 255, 255, 0.472)"
                                                    ...
                                                    @enderror
                                                    <div class="form-group color">
                                                        <input value="{{ old('shipment_code') }}" type="text"
                                                            name="shipment_code" style="color: white !important"
